...
const (
	CONFIG_FILE_PATH          = "/etc/inspector.conf"
	...
	DEFAULT_TSDB_ADDR         = "127.0.0.1:8086"
	DEFAULT_TSDB_USER         = "root"
	DEFAULT_TSDB_PWD          = "root"
...
func InitGlobalConfig() error {
	...
	GlobalConfig = &Config{
		...
		TSDB_USER:         cfg.MustValue(goconfig.DEFAULT_SECTION, "tsdb_user", DEFAULT_TSDB_USER),
		TSDB_PWD:          cfg.MustValue(goconfig.DEFAULT_SECTION, "tsdb_pwd", DEFAULT_TSDB_PWD),
