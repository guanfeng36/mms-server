...
const (
	CONFIG_FILE_PATH                 = "/etc/controller.conf"
	...
	DEFAULT_KAFKA_TASK_MGT_TOPIC     = "task_management_service"
)
...
func InitGlobalConfig() error {
	...
	GlobalConfig = &Config{
		...
		KAFKA_BROKERS:            cfg.MustValue(goconfig.DEFAULT_SECTION, "kafka_brokers", DEFAULT_KAFKA_BROKERS),
		KAFKA_TASK_MGT_TOPIC:     cfg.MustValue(goconfig.DEFAULT_SECTION, "kafka_task_mgt_topic", DEFAULT_KAFKA_TASK_MGT_TOPIC),
	}
	return nil
}
